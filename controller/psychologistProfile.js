...
const changeProfilePicture = async (req, res) => {
    try {
        ...
        if (user.profilePicture && user.profilePicture != "demo.jpg") {
            const oldProfilePicturePath = path.join(__dirname, "..", "uploads", user.profilePicture);
...
module.exports = { profileData, updateProfile, changePassword, changeProfilePicture,deleteUser };
